...
#create empty lists orig_points and dest_points
orig_points=[]
dest_points=[]
# CODE FOR TESTING YOUR SOLUTION
...
#append points in orig and dest points
